@description('Name of the PostgreSQL NSG')
param nsgName string = 'nsg-postgresql'
...
output nsgName string = postgresqlNSG.name
output nsgResourceId string = postgresqlNSG.id
