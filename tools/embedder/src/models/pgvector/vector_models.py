...
class SearchFeedback(Base):
    ...
    summary_helpful = Column(Integer, nullable=True)
    summary_accurate = Column(Integer, nullable=True)
    doc_helpful = Column(Integer, nullable=True)
    doc_accurate = Column(Integer, nullable=True)
    summary_improvement = Column(Text, nullable=True)
    doc_improvement = Column(Text, nullable=True)
