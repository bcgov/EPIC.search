...
Handles RAG + Summary mode processing - retrieval with pattern-based temporal extraction plus AI summarization.
"""
import time
...
class RAGSummaryHandler(BaseSearchHandler):
    """Handler for RAG + Summary mode processing - retrieval plus AI summarization."""
